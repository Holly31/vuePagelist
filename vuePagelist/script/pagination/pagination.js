(function (factory) {
    ...
    Pagination.prototype = {
        ...
        _drawInner: function () {
            ...
            var tpl = '<ul>' + '<li class="prev' + (this.currentPage - 1 <= 0 ? ' disabled' : ' ') + '"><a href="javascript:void(0)" data="' + (this.currentPage - 1) + '">«上一页</a></li>';
            if (this.pages <= this.displayPage || this.pages == this.displayPage + 1) {
                for (var i = 1; i < this.pages + 1; i++) {
                    i == this.currentPage ? (tpl += '<li class="active"><a href="javascript:void(0)" data="' + i + '">' + i + '</a></li>') : (tpl += '<li><a href="javascript:void(0)" data="' + i + '">' + i + '</a></li>');
                }
                ...
                if (this.currentPage < this.displayPage - 1) {
                    ...
                    tpl += '<li><a href="javascript:void(0)" data="' + this.pages + '">' + this.pages + '</a></li>';
                } else if (this.currentPage > this.pages - this.displayPage + 2 && this.currentPage <= this.pages) {
                    tpl += '<li><a href="javascript:void(0)" data="1">1</a></li>';
                    tpl += '<li class="dotted"><span>...</span></li>';
            ...
            tpl += '<li class="next' + (this.currentPage + 1 > this.pages ? ' disabled' : ' ') + '"><a href="javascript:void(0)" data="' + (this.currentPage + 1) + '">下一页»</a></li>' + '</ul>';
